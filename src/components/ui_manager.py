...
class UIManager:
    ...
    def detect_system_resolution(self) -> Tuple[int, int]:
        """Detect the actual system resolution."""
        # Create a temporary window to detect resolution
        temp_window = "temp_resolution_detect"
